...
volatile uint32_t InputCaptureValue_2=0;
volatile uint32_t InputCaptureDifference=0;
volatile int datacheck;
//CAN_DECLARATIONS================================
...
void Calculate_Speed(void)
{
    ...
    int8_t distanceChange = distance - previousDistance;
